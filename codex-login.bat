...
if not errorlevel 1 goto node_available
...
:node_version_valid
if exist "%CODEX_EXE%" goto codex_dependency_ready
...
"%CODEX_EXE%" login
if not errorlevel 1 goto login_verified
echo.
