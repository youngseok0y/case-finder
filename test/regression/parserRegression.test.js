// Consolidated from test/validatorEvidenceUx.test.js.
await (async () => {
  ...
  const { createEvidenceLedger, providerBoundCaseIdentityCompatibility } = await import("../../src/aoV2/evidenceLedger.js");
  const { finalizeSelection } = await import("../../src/aoV2/finalSelectionGate.js");
  const { lawDetailLink } = await import("../../src/directLookup.js");
