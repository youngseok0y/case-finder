// Consolidated from test/geminiPlanValidation.test.js.
await (async () => {
  const assert = (await import("node:assert/strict")).default;
  const test = (await import("node:test")).default;
  const { validatePlan } = await import("../../src/gemini.js");
...
// Consolidated from test/geminiCandidateAggregation.test.js.
await (async () => {
  const assert = (await import("node:assert/strict")).default;
  const test = (await import("node:test")).default;
  const { collectCandidates, rankCandidates } = await import("../../src/nlPipeline.js");
